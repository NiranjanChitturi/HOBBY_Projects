...
------------------------------------------------------------
-- MPHMS PHASE 1 DATABASE SCHEMA (FINAL v1.3)
------------------------------------------------------------
...
CREATE TABLE dbo.HabitScheduleHistory (
    ...
    ScheduleType NVARCHAR(50) NOT NULL DEFAULT 'Custom',
...
CREATE TABLE dbo.ProductivityScoreSnapshots (
    ...
    HabitScore DECIMAL(5,2) NOT NULL DEFAULT 0,
    GoalScore DECIMAL(5,2) NOT NULL DEFAULT 0,
...
------------------------------------------------------------
-- NOTIFICATION OUTBOX (Reliable Delivery)
------------------------------------------------------------

CREATE TABLE dbo.NotificationOutbox (
    OutboxId UNIQUEIDENTIFIER NOT NULL
        CONSTRAINT PK_NotificationOutbox PRIMARY KEY
        DEFAULT NEWSEQUENTIALID(),

    UserId UNIQUEIDENTIFIER NOT NULL,
    TemplateId UNIQUEIDENTIFIER NULL,

    Channel NVARCHAR(50) NOT NULL, -- InApp | Email
...
------------------------------------------------------------
-- END MPHMS PHASE 1 FINAL SCHEMA v1.3
------------------------------------------------------------
